		...
		<div className="p-8 space-y-4">
			...
			<div className="mt-8 space-y-2">
				...
				<div className="flex gap-4">
					<Button
						variant="tonal"
						onClick={() => nav.navigate("protected-page")}
					>
						Go to Protected Page
					</Button>
					<Button
						variant="tonal"
						onClick={() => nav.navigate("dirty-page")}
					>
...
export const ProtectedPage = () => {
	...
	return (
		<div className="p-8 bg-green-500/10 h-full">
			...
			<Button className="mt-8" onClick={() => nav.popBackStack()}>
				Go Back
			</Button>
		</div>
	);
...
export const DirtyPage = () => {
	...
	return (
		<div className="p-8 bg-orange-500/10 h-full">
			...
			<p className="mt-4">
				Try to go back using the button below OR the browser back
				button.
			</p>
			<p className="text-sm">
				The <code>confirmExitGuard</code> will trigger.
			</p>
			<Button className="mt-8" onClick={() => nav.popBackStack()}>
				Go Back (Triggers Guard)
			</Button>
		</div>
	);
};
