...
export const initialTasks: Task[] = [
	{
		...
		tags: ["frontend", "auth"],
		description:
			"Create a login page with email and password fields. Include validation and error handling.",
	},
	{
		id: "TASK-2",
		...
		tags: ["backend", "db"],
		description:
			"Design and implement the initial database schema for users and projects.",
	},
	{
		id: "TASK-3",
		...
		tags: ["design", "ui"],
		description:
			"Define color palette, typography and spacing tokens in Figma and export to CSS.",
	},
	{
		id: "TASK-4",
		...
		tags: ["bug", "frontend"],
		description:
			"Navigation state is lost when refreshing the page on the detailed view.",
	},
];
		...
		<Card className="group cursor-pointer hover:shadow-md transition-all duration-200 border-outline-variant/50 hover:border-primary/50 p-4! bg-surface">
			<div className="flex flex-col gap-3">
				<div className="flex justify-between items-start">
					<span className="text-xs font-medium text-on-surface-variant hover:underline cursor-pointer">
						{task.id}
					</span>
				...
				<h4 className="text-sm font-medium text-on-surface leading-snug">
					{task.title}
				</h4>
				...
				<div className="grid grid-cols-3 gap-8">
					...
					<div className="col-span-1 space-y-6">
						<div className="space-y-4">
							<div>
								<label className="text-xs font-semibold text-on-surface-variant uppercase mb-1 block">
									Status
								</label>
								<Status
									variant={
							...
							<div>
								<label className="text-xs font-semibold text-on-surface-variant uppercase mb-2 block">
									Tags
								</label>
								<div className="flex flex-wrap gap-2">
									{task.tags.map((tag) => (
										<span
											key={tag}
											className="px-2 py-1 rounded bg-surface-variant text-[11px] font-medium text-on-surface-variant"
										>
											{tag}
										</span>
									))}
