...
export const TagInput: React.FC<TagInputProps> = ({
	...
	return (
		<Popover
			...
			trigger={
				<div className="px-[var(--space-1)] flex flex-wrap items-center gap-[var(--space-1)] rounded-[var(--radius-component)] transition duration-150 disabled:opacity-50 disabled:pointer-events-none border border-outline-variant outline-none focus-visible:ring-primary/50 focus-visible:ring-[3px]">
